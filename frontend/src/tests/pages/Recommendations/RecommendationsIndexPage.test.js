...
describe("RecommendationsIndexPage tests", () => {
    ...
    test("renders three recommendations without crashing for regular user", async () => {
        ...
        await waitFor(() => { expect(getByTestId(`${testId}-cell-row-0-col-explanation`)).toHaveTextContent("rec"); });
        expect(getByTestId(`${testId}-cell-row-1-col-explanation`)).toHaveTextContent("rec2");
        expect(getByTestId(`${testId}-cell-row-2-col-explanation`)).toHaveTextContent("rec3");
