...
describe("RecommendationsTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    expect(getByTestId(`${testId}-cell-row-0-col-requesterEmail`)).toHaveTextContent("student@gmail.com");
    expect(getByTestId(`${testId}-cell-row-1-col-requesterEmail`)).toHaveTextContent("student2@gmail.com");
